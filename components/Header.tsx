      ...
      <div className="relative container mx-auto max-w-screen-2xl flex justify-between items-center p-3">
        ...
        <div className="hidden md:flex justify-between items-center w-full">
            ...
            <div className="flex items-center gap-2">
                ...
                <button onClick={onRandomAnime} title="Random Anime" className="text-gray-200 hover:text-white transition-colors p-2 rounded-full hover:bg-white/10 flex items-center gap-1"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" clipRule="evenodd" transform="rotate(45 10 10)" /></svg><span className="hidden sm:inline text-sm font-semibold">Random</span></button>
