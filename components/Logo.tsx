...
const Logo: React.FC<LogoProps> = ({ width = "105", height = "24", className = "" }) => (
    <svg width={width} height={height} viewBox="0 0 140 32" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
