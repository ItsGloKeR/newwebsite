...
const AppContent: React.FC = () => {
    ...
    const handleGoogleSignIn = async () => {
        ...
        if (signedInUser) {
            setIsLoginModalOpen(false); // Close modal on successful sign-in
        }
    };
                                ...
                                {!user && (
                                    <div className="space-y-4">
                                        ...
                                        <button 
                                            ...
                                            className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 font-bold py-3 px-4 rounded-md transition-colors hover:bg-gray-200"
                                        >
